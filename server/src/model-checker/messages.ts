import { Attribute, Reference, SymbolDeclaration, TreeNode } from '../model-definition/symbolsAndReferences';
...
export const CHECKS_MESSAGES = {
	...
	SEARCHCOLUMN_ATTRIBUTE_NOT_FOUND: (attribute: Reference, typeRef: Reference) => `Attribute '${attribute.value}' not found in ${typeRef.type} with name '${typeRef.name}'.`,
