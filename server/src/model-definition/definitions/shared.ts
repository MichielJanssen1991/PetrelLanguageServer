...
export const action_call_element: Definition = {
...
export const rule_action_call_element: Definition = {
	...action_call_element,
...
export const infoset_action_call_element: Definition = {
	...action_call_element,
...
export const action_argument_element: Definition = {
	...
	matchCondition: {
		...
		matchFunction: (nodeContext) => !isViewArgument(nodeContext),
	},
	attributes: [
		{
			name: NAMES.ATTRIBUTE_REMOTENAME,
